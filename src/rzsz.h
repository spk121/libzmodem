...
typedef enum Exit_code_ exitcode_t;
...
/* This runs a zmodem receiver.
   ...
   The return value is the sum of the sizes of the files successfully
   transfered. */
size_t lrz_send(int file_count,
